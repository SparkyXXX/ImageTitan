...
static const _JoystickData_type_support_symbol_names_t _JoystickData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, joy_msg, msg, JoystickData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, joy_msg, msg, JoystickData)),
  }
};
...
{
  return &::joy_msg::msg::rosidl_typesupport_cpp::JoystickData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, joy_msg, msg, JoystickData)() {
  return get_message_type_support_handle<joy_msg::msg::JoystickData>();
}
