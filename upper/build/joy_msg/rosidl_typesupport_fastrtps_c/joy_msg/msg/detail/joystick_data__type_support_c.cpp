...
#include "joy_msg/msg/detail/joystick_data__rosidl_typesupport_fastrtps_c.h"
...
#include "joy_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _JoystickData__ros_msg_type = joy_msg__msg__JoystickData;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_joy_msg
size_t get_serialized_size_joy_msg__msg__JoystickData(
  const void * untyped_ros_message,
...
static uint32_t _JoystickData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_joy_msg__msg__JoystickData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_joy_msg
size_t max_serialized_size_joy_msg__msg__JoystickData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = joy_msg__msg__JoystickData;
    is_plain =
      (
...
static size_t _JoystickData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_joy_msg__msg__JoystickData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, joy_msg, msg, JoystickData)() {
