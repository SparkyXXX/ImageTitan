...
#include "joy_msg/msg/detail/joystick_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_joy_msg
cdr_serialize(
  const joy_msg::msg::JoystickData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  joy_msg::msg::JoystickData & ros_message)
{
  // Member: axes
  {
    cdr >> ros_message.axes;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = joy_msg::msg::JoystickData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const joy_msg::msg::JoystickData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<joy_msg::msg::JoystickData *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_joy_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<joy_msg::msg::JoystickData>()
{
  return &joy_msg::msg::typesupport_fastrtps_cpp::_JoystickData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, joy_msg, msg, JoystickData)() {
  return &joy_msg::msg::typesupport_fastrtps_cpp::_JoystickData__handle;
}
