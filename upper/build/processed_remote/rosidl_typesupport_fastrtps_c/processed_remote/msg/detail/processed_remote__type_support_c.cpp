...
#include "processed_remote/msg/detail/processed_remote__rosidl_typesupport_fastrtps_c.h"
...
#include "processed_remote/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _ProcessedRemote__ros_msg_type = processed_remote__msg__ProcessedRemote;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ProcessedRemote__ros_msg_type * ros_message = static_cast<const _ProcessedRemote__ros_msg_type *>(untyped_ros_message);
  // Field name: axes
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ProcessedRemote__ros_msg_type * ros_message = static_cast<_ProcessedRemote__ros_msg_type *>(untyped_ros_message);
  // Field name: axes
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_processed_remote
size_t get_serialized_size_processed_remote__msg__ProcessedRemote(
  const void * untyped_ros_message,
...
static uint32_t _ProcessedRemote__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_processed_remote__msg__ProcessedRemote(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_processed_remote
size_t max_serialized_size_processed_remote__msg__ProcessedRemote(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = processed_remote__msg__ProcessedRemote;
    is_plain =
      (
...
static size_t _ProcessedRemote__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_processed_remote__msg__ProcessedRemote(
...
static message_type_support_callbacks_t __callbacks_ProcessedRemote = {
...
static rosidl_message_type_support_t _ProcessedRemote__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ProcessedRemote,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, processed_remote, msg, ProcessedRemote)() {
  return &_ProcessedRemote__type_support;
}
