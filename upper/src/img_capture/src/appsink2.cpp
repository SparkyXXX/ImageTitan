...
int main(int argc, char *argv[])
{
    ...
    auto node = rclcpp::Node::make_shared("camera2_10003_publisher");
    auto publisher = node->create_publisher<sensor_msgs::msg::Image>("camera2_10003_image", 10);
    if (!publisher) {
...
static GstFlowReturn new_sample_cb(GstElement *sink, gpointer data)
{
    ...
    if (gst_buffer_map(buffer, &map, GST_MAP_READ)) {
        ...
        msg->header.frame_id = "camera2_10003_frame";
